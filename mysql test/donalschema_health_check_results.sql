...
CREATE TABLE `health_check_results` (
  ...
  `response_is_ok` bit(1) DEFAULT NULL,
  `full_response` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='This table can hold results from health checks';
